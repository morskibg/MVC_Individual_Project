...
namespace Opereta.Data.Migrations
{
    ...
    [Migration("20181118182322_partialDbCreate")]
    partial class partialDbCreate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Opereta.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Opereta.Models.Meeting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Opereta.Models.MeetingDepartment", b =>
                {
                    b.Property<int>("DepartmentId");

                    b.Property<int>("MeetingId");

                    b.HasKey("DepartmentId", "MeetingId");

                    b.HasIndex("MeetingId");

                    b.ToTable("MeetingDepartment");
                });

            modelBuilder.Entity("Opereta.Models.MeetingEmployee", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Opereta.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Opereta.Models.ApplicationUser", b =>
                {
                    b.HasOne("Opereta.Models.Department", "Department")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Opereta.Models.MeetingDepartment", b =>
                {
                    ...
                    b.HasOne("Opereta.Models.Meeting", "Meeting")
                        .WithMany("InvolvedDepartments")
            ...
            modelBuilder.Entity("Opereta.Models.MeetingEmployee", b =>
                {
                    b.HasOne("Opereta.Models.ApplicationUser", "Employee")
                        .WithMany("MeetingsToParticipate")
