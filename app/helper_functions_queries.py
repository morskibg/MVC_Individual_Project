...
######################################################################################################################################################
def get_itn_by_inv_group_for_period_sub(inv_group_name, start_date, end_date):
...
def get_grid_services_amount(itn_with_grid_services_sub, 
                                stp_consumption_for_period_sub, 
                                non_stp_consumption_for_period_sub,
    ...
    #         func.round(func.sum(ItnSchedule.consumption_vol), ENERGY_ROUND).label('single_tariff_consumption'),
    #         ) 
    #         .filter(ItnSchedule.itn.in_(itn_by_inv_group_for_period_sub))           
...
# def get_grid_services_distrib_records(itn_by_inv_group_for_period_sub, invoice_start_date, invoice_end_date):
